const BaseHook = FE.requireLib('/client/hookBaseClass.js');
const winston = require('winston');
require('winston-daily-rotate-file');

class TracerHook extends BaseHook {

	constructor(_appObj) {
		super(_appObj);
		this._configs = this._appObj.configs.hooks.tracer;
		this._props = {};
	}
