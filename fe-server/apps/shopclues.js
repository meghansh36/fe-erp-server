...
moduleAlias.addAliases({
  ...
  '@L2Root':'../legislations/fe/',
  '@L2Main':'../legislations/fe/main',
  '@L2Process':__dirname+'/../legislations/fe/main/process',
  '@L3RootShopclues':'../legislations/fe/clients/shopclues',
  '@L3MainShopclues':'../legislations/fe/clients/shopclues/main',
  '@L3ProcessShopclues':'../legislations/fe/clients/shopclues/main/process',
});
moduleAlias()
...
require('../globals/clientsDetails.js');
require('../middlewares/fe.middleware.require.js');
const uuid = require('uuid');
var middleware = require('../middlewares/fe.middleware.dispatcher.js');
...
app.use('/:client/api/',function(req,res,done){
  console.log('Inside shopclues app');
  done();
},middleware);
app.use('/api', book);
