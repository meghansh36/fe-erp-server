...
const BaseHelpers = FE.requireL0('helperBaseClass.js');
...
var datetime =currentdate.getDate() + "-"
   ...
   var  stack=message[0]['stack'];
    var error= String(message[0]['error']);
  
  
 con.query("INSERT INTO fe_sys_debugger_log_t ( attribute2, attribute3, attribute4, attribute5, attribute6, attribute7,attribute8, attribute9, attribute10, attribute11, attribute12, attribute13,attribute21 ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)",["1","2","3","Exception","code","Exception",error,"9",stack,11,index,line,datetime], function (err, result) {
     if (err) throw err;
  console.log("Done");
   });   
  }
